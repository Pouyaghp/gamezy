...
/* Poster: shows your real photo if you've added one
   (public/images/games/<slug>.jpg), otherwise a brand-coloured
...
export function GamePoster({ game, showTitle = true }) {
  ...
  return (
    <div className="poster-ph" style={{ background: "linear-gradient(150deg," + c1 + "," + c2 + ")" }}>
      ...
      <div className="ph-logo"><img src="/images/logo.png" alt="" style={{ width: "100%", display: "block" }} /></div>
